...
import 'package:flutter_dialog_demo/sencond_page.dart';
          ...
          children: <Widget>[
            ...
            Padding(
              padding:
                  const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
              child: CupertinoButton(
                  child: const Text('已弹出低优先级弹窗，显示高优先级弹窗，是否可以回收显示'),
                  onPressed: () {
                    DialogManager()
                      ..add(DialogBean(
            ...
            Padding(
              padding:
                  const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
              child: CupertinoButton(
                  child: const Text('已弹出低优先级弹窗，显示高优先级并清除其它的弹窗'),
                  onPressed: () {
                    DialogManager()
                      ..add(DialogBean(
                        createDialogWidget: () =>
